...
static Key keys[] = {
    ...
    { 0,                            XF86XK_AudioPlay,          spawn,          SHCMD("playerctl play-pause && sleep 0.1 && pkill -RTMIN+1 dwmblocks") },
    { 0,                            XF86XK_AudioNext,          spawn,          SHCMD("playerctl next       && sleep 0.1 && pkill -RTMIN+1 dwmblocks") },
    { 0,                            XF86XK_AudioPrev,          spawn,          SHCMD("playerctl previous   && sleep 0.1 && pkill -RTMIN+1 dwmblocks") },
